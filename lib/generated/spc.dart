...
class Vars extends VarListWithAccessSpec {
  Vars({
    required super.accessSpecifier,
    super.variables,
    super.usingDirectives,
    required super.documentation,
    required super.addData,
...
class Parameters extends ParameterSet {
  Parameters({required super.items});
}

class ResultType extends TypeRef {
  ResultType({required super.item});
}
...
class InitialValue extends Value {
  InitialValue({required super.item});
}
